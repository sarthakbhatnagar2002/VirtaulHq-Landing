        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="group relative cursor-pointer">
              <div className="relative h-full p-6 bg-gradient-to-br from-neutral-900/50 to-neutral-800/50 border border-neutral-700/50 hover:border-blue-500/30 transition-all group-hover:scale-105 rounded-none">
