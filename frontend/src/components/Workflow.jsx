        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            {checklistItems.map((item, index) => (
              <div
                key={index}
                className="flex gap-6 p-6 rounded-none border-2 border-blue-500 bg-neutral-900 cursor-pointer shadow-[4px_4px_0px_#1e40af] hover:scale-105 transition-transform"
              >
